...
class HuangBaiB1V4Strategy(BaseStrategy):
    ...
    def _check_entry(self):
        ...
        self.buy_info = {
            ...
            "bar": len(self),
            "bought_below_yellow": self.data.close[0] < self._yellow[idx],
        }
...
def _scan_one(code, params, skip_weekly, market_macd_ok=True):
    ...
    try:
        ...
        if sig["b1"] and weekly_ok and dongneng_recent and vol_expand_ok and no_huge_vol_bearish and market_macd_ok:
            sig["code"] = code
