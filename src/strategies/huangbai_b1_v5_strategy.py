...
def _scan_one(code, params, skip_weekly, market_macd_ok=True):
    ...
    try:
        ...
        if sig["b1"] and weekly_ok and stock_macd_ok and vol_expand_ok and no_huge_vol_bearish and market_macd_ok:
            sig["code"] = code
...
def _compute_all_bar_signals(C, H, L, O, V, dates, params):
    ...
    _rr_ok = (_rr_reward >= _rr_risk) | (_rr_risk <= 0)
    b1 = b1 & _rr_ok
